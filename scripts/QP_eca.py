...
class subscriber_QP:
    def __init__(self):
        ...
        self.sub_objpos = rospy.Subscriber("/obs_pos", Pose, self.QP_callback_sub_objpos, queue_size=10)
    ...
    def QP_callback_sub_objpos(self, msg):
        self.message_objpos = [msg.position.x, msg.position.y, msg.position.z]
    
    def return_message(self):
        return self.message_joint_position, self.message_joint_velocity, self.message_ee, self.message_state, self.message_fext, self.message_objpos
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        objpos = Subscriber_QP.return_message()[5]
        print("current pos: ", objpos)
        # q_save.append(q)
        ...
        # end_pos_ball = [objpos[0], objpos[1], objpos[2]]
        ...
        fx = [-1 * (end_pos[0] - 0.7), -1 * (end_pos[1] + 0), -1 * (end_pos[2] - 0.5)]
