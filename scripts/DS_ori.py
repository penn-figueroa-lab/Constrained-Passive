...
class subscriber_QP:
    ...
    def return_message(self):
        return self.message_joint_position, self.message_joint_velocity, self.message_ee, self.message_state, self.message_fext, self.message_ee_ori
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        target_torque = np.transpose(Jacobian_all) @ np.concatenate(([0, 0, 0], fc_wrench))
